...
namespace FerreteriaApp.Datos
{
    public class DMovimiento
    {
        ...
        public bool Agregar(Movimiento obj)
        {
        ...
        public List<Movimiento> ListarxProducto(string Producto)
        {
            List<Movimiento> List = new List<Movimiento>();
            try
            {
        ...
        public List<Movimiento> ListarxPeriodoxProducto(string Periodo, string Producto)
        {
            List<Movimiento> List = new List<Movimiento>();
            try
            {
        ...
        public Movimiento SeleccionarUltimoMovimientoProducto(string Producto)
        {
            try
            {
                SQLParameter[] parameters = new SQLParameter[1];
        ...
        public Movimiento SeleccionarUltimoMovimientoProductoFinal(string Producto)
        {
            try
            {
                SQLParameter[] parameters = new SQLParameter[1];
